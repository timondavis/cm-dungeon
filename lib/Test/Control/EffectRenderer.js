...
describe('EffectRenderer', function () {
    ...
    it('will set (new or override) new statuses on the actor, based on directives from the effect', function () {
        ...
        s.setOwner(defender);
        s.attributeEffectFilters.add('Intelligence', function (value) {
            return value - 2;
        });
        var effect = new Effect_1.Effect();
        ...
        chai_1.expect(function () { return retrievedStatus.attributeEffectFilters.get('Bravery'); }).to.throw;
        chai_1.expect(function () { return retrievedStatus.attributeEffectFilters.get('Fear'); }).not.to.throw;
    });
    it('will remove statuses from the actor, if they exist.  Order to remove non-existing statuses will be ignored.', function () {
        ...
        s1.attributeEffectFilters.add('Intelligence', function (value) {
            return value - 2;
        });
        s2.attributeEffectFilters.add('Wisdom', function (value) {
            return value - 4;
        });
        var effect = new Effect_1.Effect();
        ...
        chai_1.expect(function () { return retrievedStatus.attributeEffectFilters.get('Bravery'); }).to.throw;
        chai_1.expect(function () { return retrievedStatus.attributeEffectFilters.get('Fear'); }).not.to.throw;
        chai_1.expect(function () { return retrievedStatus.attributeEffectFilters.get('Wroth'); }).not.to.throw;
        effects = new List_1.List();
        effect = new Effect_1.Effect();
        ...
        effects.add(effect);
        chai_1.expect(function () { return retrievedStatus.attributeEffectFilters.get('Bravery'); }).to.throw;
        chai_1.expect(function () { return retrievedStatus.attributeEffectFilters.get('Fear'); }).to.throw;
        chai_1.expect(function () { return retrievedStatus.attributeEffectFilters.get('Wroth'); }).not.to.throw;
    });
    it('processes status effect filters for attributes', function () {
        ...
        invincibilityStatus.attributeEffectFilters.add('HP', function () {
            return 0;
        });
