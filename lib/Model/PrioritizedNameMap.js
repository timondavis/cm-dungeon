...
var PrioritizedNameMap = /** @class */ (function (_super) {
    __extends(PrioritizedNameMap, _super);
    function PrioritizedNameMap() {
        var _this = _super.call(this) || this;
        _this.state = {
            namePriorityIndex: new NameMap_1.NameMap(),
            prioritizedNames: new NumberMap_1.NumberMap()
        };
        return _this;
    }
    Object.defineProperty(PrioritizedNameMap.prototype, "prioritizedNames", {
        get: function () { return this.state.prioritizedNames; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(PrioritizedNameMap.prototype, "namePriorityIndex", {
        get: function () { return this.state.namePriorityIndex; },
        enumerable: true,
        configurable: true
    });
    /**
    ...
    PrioritizedNameMap.prototype.toMap = function () {
